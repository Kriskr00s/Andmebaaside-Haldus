...
insert into Gender (Id, Gender)
values (3, 'Unknown')
--alter table Person vaikimisi lisatakse gender id = 3
alter table Person
...
-- kuvab ainult linna mille nimi on Gotham
select * from Person where City = 'Gotham'
update Person set City = 'Tartu' where id = 5
...
update person set age = 20 where id = 7
